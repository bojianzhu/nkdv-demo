        ...
        <div className="header" style={{  animation: fullScreen ? 'header-slide-up 1000ms forwards' : 'header-slide-down 1000ms forwards' }}>
          <div className="pc-header-container">
            ...
            <div className="header-seperator"></div> */}
              <div className="pc-title-container">
                <div className="title-container">
                  ...
                  <a href="https://github.com/edisonchan2013928/PyNKDV" className="header-text header-title2">({intl.get('header-title2')})</a>
                </div>
            ...
            <div className="header-right">
              ...
              <a href="https://www.hku.hk/">
                <img className="header-img3" src={ "./img/szu-logo.png"} />
              </a>
          ...
          <div className="mobile-header-container">
            ...
            <div className="mobile-title-container">
              ...
              <div style={{ lineHeight: 0.6 }}><a href="https://github.com/edisonchan2013928/PyNKDV" className="header-text header-title2"> {intl.get('header-title2')} </a></div>
  ...
  return (
	<div className="update-container">
      <div className="pc-update-container" style={{  animation: fullScreen ? 'update-slide-down 1000ms forwards' : 'update-slide-up 1000ms forwards' }}>
        <div className="update-text"> {intl.get('update-text1')}<a href="https://figshare.com/articles/dataset/San_Francisco_taxi_trajectories/12302243" className="update-text">{intl.get('update-text2')}</a></div>
      </div>
      ...
      <div className="abouts-container">
        ...
        <div style={{ padding: '4px 0'}}>
          <div className="abouts-text">{intl.get('abouts-text1')}
            ...
            {intl.get('abouts-text2')} <a href="https://figshare.com/articles/dataset/San_Francisco_taxi_trajectories/12302243">{intl.get('abouts-text3')} </a> {intl.get('abouts-text4')}
          </div>
        </div>
      </div>
  );
      ...
      <div className="menu-container">
        <>
          <nav className="menu">
            ...
            <a href="#/nkdv" className="menu-item" onClick={ updateShowLayers }>
              {" "}
              <IoLayers className="menuIcon" />
            </a>
            <a href="#/nkdv" className="menu-item" onClick={ updateShowSettings }>
              {" "}
              <GoSettings className="menuIcon" />
            </a>
            <a href="#/nkdv" className="menu-item" onClick={ updateShowAbouts }>
              {" "}
              <AiOutlineInfo className="menuIcon" />
            </a>
            <a href="#/nkdv" className="menu-item" onClick={ updateFullScreen }>
              {" "}
          ...
          {Object.keys(settings).map(key => (
            ...
            <div key={key} className="setting-row">
              ...
              <label className="setting-item">{intl.get(propTypes[key].displayName)}</label>
                {
                propTypes[key].displayName=="STKDV" &&
                <HtmlTooltip
                title={
                  <React.Fragment>
                  {intl.get('tool-tip1')}
  ...
  return (
    <div>
      ...
      <div className="calendar-container" style={ openCalendar ? {padding: 0} : {paddingBottom: ''}}>
        ...
        <div className="calendarDate-container">
          <span className="calendar-sub-title">{intl.get('to')}</span>
          <div className="calendar-left">
